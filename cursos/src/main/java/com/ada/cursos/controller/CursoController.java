...
public class CursoController {
	...
	@Operation(summary = "updateCurso", description = "Modifica un objeto curso a la base de datos")
	...
	public ResponseEntity<Curso> updateCurso(@RequestBody CursoForm cursoForm, @PathVariable Long id) {
		...
		if (Optional.empty().equals(cursoOp)) {
			...
			curso = cursoServ.generarCursoDeForm(cursoForm, curso);
			cursoRepo.save(curso);
			log.info("metodo: Curso modificado.");
